...
# events = graph.request("2499497316992905")
# events = graph.get_object(id="2499497316992905")
# posts = graph.get_connections(id='2499497316992905', connection_name='posts')
# graph.put_object(parent_object='me', connection_name='feed', message='Hello World using Python')
# graph.put_object("2499497316992905", "feed", message="Hello, world")
# graph.put(message="hello world using python", profile_id='2499497316992905')
# facebook_page_id = "2499497316992905"
# graph.put_object(facebook_page_id, "feed", message='test message')
# site_info = graph.get_object(id="https://www.facebook.com/profile.php?id=100007979835832&ref=bookmarks", fields="og_object")
# print(site_info)
...
# feed = graph.get_connections("me", "feed") # Listing all of the recent posts
# for p in feed['data']:
#     if 'message' in p:
#         print(p['message'])
# user = graph.get_object("me")
friends = graph.get_connections('me', "friends") # Listing the # of your friends (since a lot people of hundreds of friends on Facebook)
print(friends['summary']['total_count'])
print('hi')
asd = 'me'
if 'urls' in Current['person']:
    for each in Current['person']['urls']:
